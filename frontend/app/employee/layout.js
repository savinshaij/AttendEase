              ...
              >
                ...
                <nav className="flex-1 px-4 py-6 space-y-1 overflow-y-auto custom-scrollbar">
                  <motion.div variants={itemVariants}>
                    <SidebarLink href="/employee/dashboard" icon={<LayoutDashboard size={DEFAULT_ICON_SIZE} strokeWidth={DEFAULT_ICON_STROKE_WIDTH} />}>
                      Dashboard
                    </SidebarLink>
                  </motion.div>

                  <motion.div variants={itemVariants}>
                    <SidebarLink href="/employee/attendance" icon={<Clock size={DEFAULT_ICON_SIZE} strokeWidth={DEFAULT_ICON_STROKE_WIDTH} />}>
                      Attendance
                    </SidebarLink>
                  </motion.div>

                  <motion.div variants={itemVariants}>
                    <SidebarLink href="/employee/tasks/my" icon={<ClipboardList size={DEFAULT_ICON_SIZE} strokeWidth={DEFAULT_ICON_STROKE_WIDTH} />}>
                      My Tasks
                    </SidebarLink>
                  </motion.div>
                  ...
                  <motion.div variants={itemVariants}>
                    <SidebarSubMenu
                      ...
                      icon={<Calendar size={DEFAULT_ICON_SIZE} strokeWidth={DEFAULT_ICON_STROKE_WIDTH} />}
                      items={[
                        { href: "/employee/duty/my", label: "My Duties" },
                        { href: "/employee/duty/my-requests", label: "Requests" },
                        { href: "/employee/duty/assign", label: "Request Handover" },
                      ]}
                  ...
                  <motion.div variants={itemVariants}>
                    <SidebarSubMenu
                      ...
                      icon={<FileText size={DEFAULT_ICON_SIZE} strokeWidth={DEFAULT_ICON_STROKE_WIDTH} />}
                      items={[
                        { href: "/employee/leave/apply", label: "Apply Leave" },
                        { href: "/employee/leave/leave-balance", label: "Leave Balance" },
                        { href: "/employee/leave/my-requests", label: "My Leave Requests" },
                      ]}
                      onLinkClick={() => setMobileMenuOpen(false)}
                    />
                  </motion.div>
                  ...
                  <motion.div variants={itemVariants}>
                    <SidebarLink href="/employee/feedback" icon={<MessageSquare size={DEFAULT_ICON_SIZE} strokeWidth={DEFAULT_ICON_STROKE_WIDTH} />}>
                      Feedback
                    </SidebarLink>
                  </motion.div>
                </nav>
