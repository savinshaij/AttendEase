                ...
                <nav className="flex-1 px-4 py-6 space-y-1 overflow-y-auto custom-scrollbar">
                  <motion.div variants={itemVariants}>
                    <SidebarLink
                      ...
                      icon={<LayoutDashboard size={DEFAULT_ICON_SIZE} strokeWidth={DEFAULT_ICON_STROKE_WIDTH} />}
                    >
                      Dashboard
                    </SidebarLink>
                  </motion.div>
                  <motion.div variants={itemVariants}>
                    <SidebarLink
                      href="/admin/add-attendance"
                      icon={<CalendarCheck size={DEFAULT_ICON_SIZE} strokeWidth={DEFAULT_ICON_STROKE_WIDTH} />}
                    >
                      Attendance
                    </SidebarLink>
                  </motion.div>
                  <motion.div variants={itemVariants}>
                    <SidebarLink
                      ...
                      icon={<BellRing size={DEFAULT_ICON_SIZE} strokeWidth={DEFAULT_ICON_STROKE_WIDTH} />}
                  ...
                  <motion.div variants={itemVariants}>
                    <SidebarSubMenu
                      ...
                      icon={<UserCog size={DEFAULT_ICON_SIZE} strokeWidth={DEFAULT_ICON_STROKE_WIDTH} />}
                      items={[
                        { href: "/admin/register-user", label: "Register User" },
                        { href: "/admin/user-management", label: "Manage Users" },
                      ]}
                  ...
                  <motion.div variants={itemVariants}>
                    <SidebarSubMenu
                      ...
                      icon={<Plane size={DEFAULT_ICON_SIZE} strokeWidth={DEFAULT_ICON_STROKE_WIDTH} />}
                      items={[
                        { href: "/admin/leave-policy", label: "Leave Policies" },
                        { href: "/admin/init-balance", label: "Initialize Leave Balances" },
                  ...
                  <motion.div variants={itemVariants}>
                    <SidebarSubMenu
                      title="Duty Handover"
                      icon={<Handshake size={DEFAULT_ICON_SIZE} strokeWidth={DEFAULT_ICON_STROKE_WIDTH} />}
                      items={[
                        { href: "/admin/duty/all-requests", label: "All Requests" },
                        { href: "/admin/duty/assign", label: "Assign Duty" },
                      ]}
                      onLinkClick={() => setMobileMenuOpen(false)}
                    />
                  </motion.div>
                  <motion.div variants={itemVariants}>
                    <SidebarSubMenu
                      ...
                      items={[
                        { href: "/admin/tasks/all", label: "Tasks" },
                        { href: "/admin/tasks/assign", label: "Assign Task" },
                      ]}
                      onLinkClick={() => setMobileMenuOpen(false)}
                    />
                  </motion.div>
                  <motion.div variants={itemVariants}>
                    <SidebarLink
                      ...
                      href="/admin/feedback"
                      icon={<MessageSquare size={DEFAULT_ICON_SIZE} strokeWidth={DEFAULT_ICON_STROKE_WIDTH} />}
                    >
                      Feedback
                    </SidebarLink>
                  </motion.div>
...
const SidebarLink = memo(function SidebarLink({ href, children, icon }) {
  ...
  return (
    <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
      ...
      >
        <span className={`mr-3 flex-shrink-0 transition-colors ${isActive ? "text-blue-500" : "text-gray-500 hover:text-blue-500"
          }`}>
          {icon}
        </span>
...
const SidebarSubMenu = memo(function SidebarSubMenu({ title, icon, items, onLinkClick }) {
  ...
  return (
    <div className="space-y-1">
      ...
      >
        <div className="flex items-center">
          <span className={`mr-3 flex-shrink-0 ${hasActiveItem ? "text-blue-500" : "text-gray-500"
            }`}>
            {icon}
          </span>
